    ...
    var body: some View {
        VStack {
            ...
            HStack(spacing: 30) {
                ...
                .accessibility(identifier: "coffeeRatioVStack")
                ...
                .accessibilityElement(children: .contain)
                .accessibility(identifier: "waterInputVStack")
            }
            .accessibilityElement(children: .contain)
            .accessibility(identifier: "waterHStack")
        }
        .accessibilityElement(children: .contain)
        .accessibility(identifier: "waterVStack")
    }
}
